...
import { ArrowRight, Code, Database, LineChart, Lightbulb, Rocket, Users, Zap, CheckCircle } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
            <div className="bg-gray-800/30 p-8 rounded-lg border border-gray-700">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-custom-light/70">Market research and competitive analysis</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-blue-400 mt-0.5 flex-shrink-0" />
              ...
              <Link to="/contact">
                <Button variant="outline" className="w-full text-custom-light border-custom-light/20 hover:bg-custom-light/10">
            ...
            <div className="bg-gray-800/30 p-8 rounded-lg border border-gray-700">
              ...
              <h3 className="text-2xl font-semibold text-custom-light mb-4">Technical Development</h3>
              <p className="text-custom-light/70 mb-6">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700">
              ...
              <h3 className="text-xl font-semibold text-custom-light mb-3">Technical Due Diligence</h3>
              <p className="text-custom-light/70">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-800/30 p-8 rounded-lg border border-gray-700 flex flex-col">
              ...
              <div className="text-3xl font-bold text-custom-light mb-6">
                Starting at $5,000
              </div>
