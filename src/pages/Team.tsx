        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {teamMembers.map((member) => (
              <div key={member.id} className="bg-gray-800/30 rounded-lg border border-gray-700 overflow-hidden">
            ...
            <div className="space-y-6">
              <div className="p-4 border border-gray-700 rounded-lg bg-gray-800/50">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  <div>
                    <h4 className="text-xl font-medium text-custom-light">Senior Full-Stack Developer</h4>
              ...
              <div className="p-4 border border-gray-700 rounded-lg bg-gray-800/50">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  <div>
                    <h4 className="text-xl font-medium text-custom-light">Machine Learning Engineer</h4>
