...
const caseStudies: CaseStudy[] = [
  {
    ...
    description: 'Helping a SaaS startup reduce support costs with an intelligent chatbot that handles 70% of customer inquiries.',
    challenge: 'The client was struggling with scaling their customer support team as their user base grew rapidly. They needed a solution to handle common inquiries without increasing headcount.',
    solution: 'We developed an AI-powered chatbot that could understand customer questions and provide accurate responses. The system was integrated with their knowledge base and could escalate complex issues to human agents.',
    results: [
  ...
  },
  {
    ...
    description: 'Building a scalable microservices architecture for a fintech startup to process thousands of transactions per second.',
    challenge: 'The client needed a highly reliable and scalable payment processing system that could handle peak loads during special events and promotions.',
    solution: 'We designed and implemented a microservices architecture using event-driven patterns to ensure high throughput and fault tolerance. The system was deployed on Kubernetes for easy scaling.',
    results: [
  ...
  },
  {
    ...
    description: 'Creating a HIPAA-compliant data pipeline and analytics dashboard for a healthtech startup.',
    challenge: 'The client had valuable healthcare data but lacked the infrastructure to process it securely and extract meaningful insights for their customers.',
    solution: 'We built a secure data ingestion pipeline with proper encryption and anonymization, followed by an analytics platform that generated actionable insights from the processed data.',
    results: [
  ...
  },
  {
    ...
    description: 'Developing a personalized product recommendation system that increased average order value by 23%.',
    challenge: 'The client\'s e-commerce platform had a large product catalog but struggled with helping customers discover relevant products, resulting in low conversion rates.',
    solution: 'We implemented a machine learning recommendation engine that analyzed user behavior, purchase history, and product attributes to suggest relevant items to each customer.',
    results: [
  ...
  },
  {
    ...
    description: 'Reimagining the user experience for a mobile banking application to improve engagement and feature adoption.',
    challenge: 'The client\'s existing mobile app had poor user engagement and low feature adoption despite offering valuable banking services.',
    solution: 'We conducted user research to identify pain points and redesigned the app with a focus on intuitive navigation and streamlined workflows. We also implemented a new frontend using React Native.',
    results: [
  ...
  },
  {
    ...
    description: 'Building a secure, HIPAA-compliant video consultation platform for healthcare providers.',
    challenge: 'The client needed a reliable and secure platform for doctors to conduct virtual consultations with patients, with specific requirements for scheduling, payment processing, and medical record integration.',
    solution: 'We developed a full-stack telemedicine platform with video conferencing, appointment scheduling, secure messaging, and electronic health record integration.',
    results: [
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {featuredCaseStudies.map(caseStudy => (
                <div key={caseStudy.id} className="bg-gray-800/30 rounded-lg border border-gray-700 overflow-hidden flex flex-col md:flex-row">
                  ...
                  <div className="md:w-3/5 p-6">
                    ...
                    <h3 className="text-2xl font-semibold text-custom-light mb-2">{caseStudy.title}</h3>
                    <p className="text-custom-light/70 mb-4">
            ...
            <Tabs defaultValue="all" className="w-full">
              <div className="mb-6">
                ...
                <TabsList className="w-full bg-gray-800">
                  ...
                  {(Object.entries(categoryLabels) as [CaseStudyCategory, string][]).map(([category, label]) => (
                    <TabsTrigger
                      key={category}
                      value={category}
              ...
              <div className="mb-8">
                ...
                <TabsList className="w-full bg-gray-800">
                  ...
                  {(Object.entries(industryLabels) as [CaseStudyIndustry, string][]).map(([industry, label]) => (
                    <TabsTrigger
                      key={industry}
                      value={industry}
          ...
          {filteredCaseStudies.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredCaseStudies.map(caseStudy => (
                <Card key={caseStudy.id} className="h-full flex flex-col overflow-hidden border-gray-800 bg-custom-dark/50">
                    ...
                    <div className="mt-4">
                      ...
                      <ul className="space-y-1">
                        ...
                        {caseStudy.results.length > 2 && (
                          <li className="text-sm text-blue-400">+ {caseStudy.results.length - 2} more results</li>
                        )}
                      </ul>
                    </div>
                  </CardContent>
                  <CardFooter>
                    <Link to={`/case-studies/${caseStudy.id}`} className="w-full">
                      <Button variant="outline" className="w-full text-custom-light border-gray-700 hover:bg-gray-800">
                        Read Case Study <ArrowRight className="ml-2 h-4 w-4" />
                      </Button>
                    </Link>
                  </CardFooter>
